...
void OrbitalBase::updateIons(ParticleSet& P)
{
  APP_ABORT("OrbitalBase::updateIons(ParticleSet& P) not specified\n");
}

void OrbitalBase::updateIons(ParticleSet& P, int iat)
{
  APP_ABORT("OrbitalBase::updateIons(ParticleSet& P, int iat) not specified\n");
}
